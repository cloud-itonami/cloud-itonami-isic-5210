# Operator Quickstart — Storage (terminal/depot)

Shortest path from clone to a verified local dry-run for **ISIC 5210** (`cloud-itonami-isic-5210`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5210.git
cd cloud-itonami-isic-5210
```
...
- Blueprint governor key: `terminal-storage-governor`
- Likely source path: `terminal.governor.cljc`
